...
public class ProductionDashboardView {
    ...
    public ProductionDashboardView(User user) {
    ...
    private VBox createHeaderSection() {
        ...
        Text subtitleText = new Text("Welcome back, " + currentUser.getUsername() + 
    ...
    private HBox createQuickActionsSection() {
        ...
        newOrderBtn.setOnAction(e -> showNewOrderDialog());
        
        Button startProductionBtn = createModernButton("Start Production", "#27ae60", "▶️");
        startProductionBtn.setOnAction(e -> showStartProductionDialog());
        
        Button qualityCheckBtn = createModernButton("Quality Check", "#f39c12", "🔍");
        qualityCheckBtn.setOnAction(e -> showQualityCheckDialog());
    ...
    private void showNewOrderDialog() {
        showInfo("Feature Coming Soon", "New Order creation dialog will be implemented.");
    }

    private void showStartProductionDialog() {
        showInfo("Feature Coming Soon", "Start Production dialog will be implemented.");
    }

    private void showQualityCheckDialog() {
        showInfo("Feature Coming Soon", "Quality Check dialog will be implemented.");
    }

    private void showReportsView() {
        showInfo("Feature Coming Soon", "Reports view will be implemented.");
    }
